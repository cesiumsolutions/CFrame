...
##                 (${ARGS_TYPE} STREQUAL "TEST") OR
  ...
  set( _OUTPUT_NAME          ${ARGS_OUTPUT_NAME} )
  set( _PROJECT_LABEL        ${ARGS_PROJECT_LABEL} )
  set( _TYPE                 ${ARGS_TYPE} )
  set( _LINK_TYPE            ${ARGS_LINK_TYPE} )
  set( _GROUP                ${ARGS_GROUP} )
  set( _INCLUDE_DIRS         ${ARGS_INCLUDE_DIRS} )
  set( _DEFINES              ${ARGS_DEFINES} )
  set( _COMPILE_FLAGS        ${ARGS_COMPILE_FLAGS} )
  set( _LINK_FLAGS           ${ARGS_LINK_FLAGS} )
  set( _LIBRARY_DIRS         ${ARGS_LIBRARY_DIRS} )
  set( _LIBRARIES            ${ARGS_LIBRARIES} )
  set( _HEADERS_PUBLIC       ${ARGS_HEADERS_PUBLIC} )
  set( _HEADERS_PRIVATE      ${ARGS_HEADERS_PRIVATE} )
  set( _SOURCES              ${ARGS_SOURCES} )
  set( _QT_MOCFILES          ${ARGS_QT_MOCFILES} )
  set( _QT_UIFILES           ${ARGS_QT_UIFILES} )
  set( _QT_QRCFILES          ${ARGS_QT_QRCFILES} )
  set( _NO_INSTALL           ${ARGS_NO_INSTALL} )
  set( _HEADERS_INSTALL_DIR  ${ARGS_HEADERS_INSTALL_DIR} )
  set( _FILES_INSTALL_DIR    ${ARGS_FILES_INSTALL_DIR} )
  set( _BINARY_INSTALL_DIR   ${ARGS_BINARY_INSTALL_DIR} )
